...
DEDUP_FILES = sorted(glob.glob('outFilesS/*_Dedup.bam'))
GFF_FILE = 'reference/gencode_M37/gencode.vM37.annotation.gff3'
OUT_FILE_FREQ = 'S/PhotoSeq_Spatial_GeneBarcodeCounts.csv'
OUT_FILE = 'S/PhotoSeq_Spatial_GeneCounts.csv'
...
def main():
  ...
  photoseq_counts.rename(columns={'Gene name': 'Gene',
                             'TAN1rm/GTTAGG': 'BreastMidTumor_1', 
                             'TAN2rm/GTTAGG': 'BreastMidTumor_2',
                             'TAN3rm/GTTAGG': 'BreastMidTumor_3',
                             'TAN1rm/AGGGTA': 'BreastMidNormalAdjacent_1',
                             'TAN2rm/AGGGTA': 'BreastMidNormalAdjacent_2',
                             'TAN3rm/AGGGTA': 'BreastMidNormalAdjacent_3',
                             'TAN1rm/TATGGA': 'BreastMidNormal_1', 
                             'TAN2rm/TATGGA': 'BreastMidNormal_2',
                             'TAN3rm/TATGGA': 'BreastMidNormal_3',
                             'MAN1rm/GTTAGG': 'LungMetastasis_1', 
                             'MAN2rm/GTTAGG': 'LungMetastasis_2',
                             'MAN3rm/GTTAGG': 'LungMetastasis_3',
                             'MAN1rm/AGGGTA': 'LungNormalAdjacent_1',
                             'MAN2rm/AGGGTA': 'LungNormalAdjacent_2',
                             'MAN3rm/AGGGTA': 'LungNormalAdjacent_3',
                             'MAN1rm/TATGGA': 'LungNormal_1', 
                             'MAN2rm/TATGGA': 'LungNormal_2',
                             'MAN3rm/TATGGA': 'LungNormal_3'},
                    inplace=True)

  photoseq_counts = photoseq_counts[['Gene', 'BreastMidTumor_1', 'BreastMidTumor_2', 'BreastMidTumor_3', 'BreastMidNormalAdjacent_1', 'BreastMidNormalAdjacent_2', 'BreastMidNormalAdjacent_3', 'BreastMidNormal_1', 'BreastMidNormal_2', 'BreastMidNormal_3', 'LungMetastasis_1', 'LungMetastasis_2', 'LungMetastasis_3', 'LungNormalAdjacent_1', 'LungNormalAdjacent_2', 'LungNormalAdjacent_3', 'LungNormal_1', 'LungNormal_2', 'LungNormal_3']]
